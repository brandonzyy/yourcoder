...
`,
  ...
  const home = process.env.YC_TEST_HOME
  process.env.YC_TEST_HOME = tmp.path
...
test("discovers global skills from ~/.claude/skills/ directory", async () => {
  ...
  const originalHome = process.env.YC_TEST_HOME
  process.env.YC_TEST_HOME = tmp.path
  ...
  try {
    ...
    process.env.YC_TEST_HOME = originalHome
  }
})
