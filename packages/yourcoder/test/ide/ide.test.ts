...
import { Ide } from "../../src/config/ide"
...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders YC_CALLER", () => {
    process.env["YC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode YC_CALLER", () => {
    process.env["YC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown YC_CALLER", () => {
    process.env["YC_CALLER"] = "unknown"
