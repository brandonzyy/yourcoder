...
declare global {
  const YC_VERSION: string
  const YC_CHANNEL: string
}
...
export namespace Installation {
  ...
  export async function method() {
    if (process.execPath.includes(path.join(".yourcoder", "bin"))) return "curl"
  ...
  export const VERSION = typeof YC_VERSION === "string" ? YC_VERSION : "local"
  export const CHANNEL = typeof YC_CHANNEL === "string" ? YC_CHANNEL : "local"
  export const USER_AGENT = `opencode/${CHANNEL}/${VERSION}/${Flag.YC_CLIENT}`
  ...
  export async function latest(installMethod?: Method) {
    ...
    if (detectedMethod === "brew") {
      ...
      return fetch("https://formulae.brew.sh/api/formula/yourcoder.json")
        .then((res) => {
    ...
    if (detectedMethod === "scoop") {
      return fetch("https://raw.githubusercontent.com/ScoopInstaller/Main/master/bucket/yourcoder.json", {
