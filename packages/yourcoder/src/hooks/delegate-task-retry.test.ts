...
} from "./delegate-task-retry"
import { buildRetryGuidance } from "./delegate-task-retry"
...
describe("yac-task-retry", () => {
  ...
  describe("detectDelegateTaskError", () => {
    ...
    it("should detect unknown agent error", () => {
      const output = '[ERROR] Unknown agent: "fake-agent". Available agents: explore, codersearch, oracle'
