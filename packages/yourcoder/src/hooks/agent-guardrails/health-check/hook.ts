 ...
 *
 * Injects a system reminder on session start to prompt Yac
...
**Required checks:**
1. codereye - Test with a simple manon_search query
2. codersearch - Test with a simple search
3. coderhand - Test with a simple task delegation
...
✅ codereye: Ready (120ms)
✅ codersearch: Ready (95ms)
✅ coderhand: Ready (150ms)
