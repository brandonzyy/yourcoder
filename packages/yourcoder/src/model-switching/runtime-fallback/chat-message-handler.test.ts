...
function deps(enabled = true) {
  const dep: Parameters<typeof createChatMessageHandler>[0] = {
    ctx: {
      ...
      client: {
        ...
        } as unknown as Parameters<typeof createChatMessageHandler>[0]["ctx"]["client"]["session"],
        tui: {
          showToast: mock(async () => ({})) as never,
        } as unknown as Parameters<typeof createChatMessageHandler>[0]["ctx"]["client"]["tui"],
      } as unknown as Parameters<typeof createChatMessageHandler>[0]["ctx"]["client"],
    } as unknown as Parameters<typeof createChatMessageHandler>[0]["ctx"],
