...
import {
  filterCompacted as filterCompactedImpl,
  fromError as fromErrorImpl,
  get as getImpl,
  parts as partsImpl,
  stream as streamImpl,
} from "./message-v2/runtime"
import { LSP } from "../lsp"
...
export namespace MessageV2 {
  ...
  export const toModelMessages = toModelMessagesImpl

  export const stream = streamImpl
  export const parts = partsImpl
  export const get = getImpl
  export const filterCompacted = filterCompactedImpl
  export const fromError = fromErrorImpl
}
