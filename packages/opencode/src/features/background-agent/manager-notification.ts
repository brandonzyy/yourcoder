...
export async function validateSessionHasOutput(client: OpencodeClient, sessionID: string): Promise<boolean> {
  try {
...
async function getParentContext(args: { client: OpencodeClient; task: BackgroundTask }): Promise<{
